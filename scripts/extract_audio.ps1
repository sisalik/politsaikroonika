...
Get-ChildItem .\video | ForEach-Object {
    ...
    ffmpeg -i $video_path -acodec pcm_s16le -ac 2 -ar 44100 $audio_path
    # Extract MP3 audio from the video
    $audio_path = ".\mp3_full\${filename}.mp3"
    ffmpeg -i $video_path -vn -acodec libmp3lame -ac 2 -ab 192k -ar 44100 $audio_path
}